...
{
  /// <summary>
  /// Trieda na spracúvanie príchodzích payment response-ov VÚB EPlatby protokolu z roku 2010 využívajúceho HMAC podpisovanie správ
  /// </summary>
  public class EPlatbaPaymentHttpResponse : EPaymentHmacSignedMessage, ISignedResponse
  {
