<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TBCardPayRequestForm.ascx.cs" Inherits="Controls_TBCardPayRequestForm" %>
...
<table>
  ...
  <tr>
    <td>ipc:</td>
    <td><asp:TextBox ID="tbIpc" runat="server" /></td>
  </tr>
  <tr>
    <td>name:</td>
