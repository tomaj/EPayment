...
*/
	...
	$returnUrl = $protocol.'://'.$_SERVER['SERVER_NAME'].dirname($_SERVER['PHP_SELF']).'/return_vb_vebpay.php';
...
<html>
<head>
    <title>VB VEBPAY / MONOGRAM EPayment Libraries for PHP</title>
...
<body>
	...
	<div class="container">
		<div class="page-header">
			<h1>VB VEBPAY <small> MONOGRAM EPayment Libraries for PHP</small></h1>
		</div>
...
<?php
	foreach ($vebPayFields as $key => $value) {
...
<?php
	if (isset($_POST['dopayment'])) {
		require_once dirname(dirname(__FILE__)).'/EPaymentMerchant_PHP/VB_VeBpay/VeBpayPaymentRequest.class.php';
